    ...
    return (
        <div className='bg-white shadow-lg w-full'>
            <div className='bg-[#FFEAAA] p-6 space-y-2'>
                ...
                <input className='w-full md:w-[40%] rounded-full border-2 bg-white border-[yellow] text-[12px] px-3 py-2 outline-none' placeholder='Ask or Search your question' />
            </div>
            <div className='flex flex-col md:flex-row w-full px-8 py-4 gap-4 md:gap-0'>
                <div className='flex md:flex-col gap-3 w-[50%]'>
                ...
                <div className='w-full text-gray-500'>
                    <ul className="grid grid-cols-2 md:grid-cols-3 gap-2 text-[12px] place-content-between">
            ...
            <hr />
            <p className='text-center text-[12px] md:text-[13px] py-3 text-gray-700'>©2024 TyrePlex Technologies & Commerce Pvt. Ltd. All Rights Reserved.</p>
        </div>
    )
}
