...
const Navbar = () => {
    return (
        <nav className='flex items-center justify-between px-8 md:px-8 xl:px-24 w-full shadow-md h-12 text-[14px] bg-white font-bold top-0 sticky z-20'>
            <Image src={logo} height='100%' width='100%' />
            <div className=''>
                <ul className="items-center gap-3 lg:gap-6 hidden md:flex text-[12px] lg:text-[14px]">
